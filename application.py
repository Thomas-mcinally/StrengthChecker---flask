...
def calculate_results(form_data: dict) -> dict:
    ...
    user_data = {
        ...
        "totalKg": float(form_data["Squat"])
        + float(form_data["Bench"])
        + float(form_data["Deadlift"]),
    ...
    for lift in ["best3SquatKg", "best3BenchKg", "best3DeadliftKg", "totalKg"]:
        ...
        lift_result = (
            str(round(people_with_lower_lift / people_in_group * 100, 1)) + "%"
        )
